...
Chl_a_winter_mean_one_degree_res = blockproc(Chl_a_winter_mean, [24 24], fun); 
Chl_a_spring_mean_one_degree_res = blockproc(Chl_a_spring_mean, [24 24], fun); 
Chl_a_summer_mean_one_degree_res = blockproc(Chl_a_summer_mean, [24 24], fun); 
Chl_a_fall_mean_one_degree_res = blockproc(Chl_a_fall_mean, [24 24], fun); 
% 
...
plot_BSea_figure_subplot(Chl_a_summer_mean_rot, ...
    ...
    [0 1],...
    'Summer'); 
% saveas(gcf, 'Chlorophyll_one_deg_summer_smoothn.png'); 
...
plot_BSea_figure_subplot(Chl_a_spring_mean_rot, ...
    ...
    [0 1],...
    'Spring'); 
% saveas(gcf, 'Chlorophyll_one_deg_spring_smoothn.png'); 
...
% saveas(gcf, 'Chlorophyll_one_deg_fall_smoothn.png'); 
...
print(fig,'Updated_Climatology_TimeSeries_for_Publication.png','-dpng','-r96');       %  *// 300 dpi
%  print(gcf, 'Ju
